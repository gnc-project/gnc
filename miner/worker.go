...
//poc code
	header.GenerationSignature=hashid.CalculateGenSinGen(parent.GenerationSignature(),parent.Generator())
...
func(worker *worker)GetCommitHeader()*types.Header{
	return worker.current.header
}