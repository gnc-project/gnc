...
func TestLegacyReceiptDecoding(t *testing.T) {
	...
	tx := NewTransaction(types.Binary,1, common.HexToAddress("0x1"), big.NewInt(1), 1, big.NewInt(1), nil)
	receipt := &Receipt{
...
func TestDeriveFields(t *testing.T) {
	...
	txs := Transactions{
		...
		NewTransaction(types.Binary,2, common.HexToAddress("0x2"), big.NewInt(2), 2, big.NewInt(2), nil),
	}
