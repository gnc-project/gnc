...
//POC code
	AddNonce(ctx context.Context,pid *big.Int,nonce *big.Int,Number *big.Int)(*core.GeneratorStateImpl,error)
	
	GetCommitHeader(ctx context.Context)(*types.Header,error)
	GetCurrentBlock(ctx context.Context)(*big.Int,error)
	GetAllGenerators(ctx context.Context)(cmap.ConcurrentMap)
}
