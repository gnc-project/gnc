...
import (
	...
	"github.com/gnc-project/gnc/eth/filters"
...
type Ethereum struct {
	...
	generatorImpl *core.GeneratorImpl
}
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	eth := &Ethereum{
		...
		//POC code
		generatorImpl:  core.NewGenerator(),
	}
	//POC code
	ethash.GeneratorImpl=eth.generatorImpl
...
func (s *Ethereum) GeneratorImpl() *core.GeneratorImpl  { return s.generatorImpl }
