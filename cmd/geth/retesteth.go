...
type CParamsGenesis struct {
	...
	Difficulty *math.HexOrDecimal256 `json:"baseTarget"`
...
func (e *NoRewardEngine) CalcDifficulty(chain consensus.ChainReader, header *types.Header, parent *types.Header) *big.Int {
	return e.inner.CalcDifficulty(chain, header, parent)
}
