...
func (b *LesApiBackend) AddNonce(ctx context.Context,pid *big.Int,nonce *big.Int,Number *big.Int)(*core.GeneratorStateImpl,error) {
	// generatorImpl:=b.eth.GeneratorImpl()
	// gsinew:=generatorImpl.NewGeneratorStateImpl(b.eth.blockchain,pid,nonce)
...
func (b *LesApiBackend) GetCommitHeader(ctx context.Context)(*types.Header,error) {
...
func (b *LesApiBackend) GetAllGenerators(ctx context.Context)(cmap.ConcurrentMap) {
	// var gsi core.GeneratorStateImpl
	// header:=b.eth.miner.GetWorker().GetCommitHeader()
    // if header==nil{
	// 	return nil,errors.New(" CommitHeader not found")
...
func (b *LesApiBackend) GetCurrentBlock(ctx context.Context)(*big.Int,error) {
	// var gsi core.GeneratorStateImpl
	// header:=b.eth.miner.GetWorker().GetCommitHeader()
    // if header==nil{
	// 	return nil,errors.New(" CommitHeader not found")
